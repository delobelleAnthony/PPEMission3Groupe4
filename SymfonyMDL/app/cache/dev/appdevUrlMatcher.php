...
class appdevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/Mdl')) {
            ...
            // LamMdlBundle_test
            if ($pathinfo === '/Mdl/test') {
                return array (  '_controller' => 'Lam\\MdlBundle\\Controller\\DefaultController::testAction',  '_route' => 'LamMdlBundle_test',);
            }

            // LamMdlBundle_inscription
            if (0 === strpos($pathinfo, '/Mdl/inscription') && preg_match('#^/Mdl/inscription(?:/(?P<num>[^/]+?))?$#s', $pathinfo, $matches)) {
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Lam\\MdlBundle\\Controller\\FormationInformatiqueController::addAction',  'num' => 1,)), array('_route' => 'LamMdlBundle_inscription'));
            }
